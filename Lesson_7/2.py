...
if __name__ == "__main__":
    ...
    Исходный массив: [18.5, 24.84, 23.24, 29.42, 24.09, 28.93, 15.83, 18.01, 48.26, 12.34]
    Результат сортировки слиянием: [12.34, 15.83, 18.01, 18.5, 23.24, 24.09, 24.84, 28.93, 29.42, 48.26]
    """
